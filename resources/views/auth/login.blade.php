            ...
            <div class="flex items-center justify-center w-full h-screen px-6 bg-white md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 lg:px-16 xl:px-12">
                <div class="w-full h-200">
                    ...
                    @csrf
                        ...
                        <button type="submit" class="block w-full px-4 py-3 mt-6 font-semibold text-white transition duration-500 ease-in-out transform bg-black rounded-lg hover:bg-gray-800 hover:to-black focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 ">{{ __('Log in') }}</button>
                    </form>
              ...
              <!--  <div class="flex justify-enter">
                    ...
                    <!-- <p class="mt-8 text-center">Need an account? 
                        <a href="/register" class="font-semibold text-blue-500 hover:text-blue-700">Sign Up</a>
                    </p> -->
                </div>
            </div>
</section>
